...
function App() {
  ...
  const copyInquiry = async (type) => {
    const message =
      type === 'model'
        ? 'Merhaba Zecution Gaming, özel bir 3D model çalışması hakkında bilgi almak istiyorum.'
        : 'Merhaba Zecution Gaming, kişiye özel araç modu yaptırmak istiyorum. Detayları görüşebilir miyiz?'
